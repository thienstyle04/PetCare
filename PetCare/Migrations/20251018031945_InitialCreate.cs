        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KhachHang_NguoiDung_MaNguoiDung",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaThuCung = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaKhachHang = table.Column<int>(type: "int", nullable: false),
                    TenThuCung = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Loai = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Giong = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    GioiTinh = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    NgaySinh = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NamSinh = table.Column<int>(type: "int", nullable: true),
                    ChuThich = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Tuoi = table.Column<int>(type: "int", nullable: true),
                    CanNang = table.Column<decimal>(type: "decimal(7,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_ThuCung_MaThuCung",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LichHen_NhanVien_MaNhanVien",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DanhGia_LichHen_MaLichHen",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaLichHen = table.Column<int>(type: "int", nullable: false),
                    MaNhanVien = table.Column<int>(type: "int", nullable: false),
                    AnhTruoc = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    AnhSau = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    GhiChuDichVu = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    NgayTao = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HoSoDichVu", x => x.MaHoSo);
                    table.ForeignKey(
                        name: "FK_HoSoDichVu_LichHen_MaLichHen",
                        column: x => x.MaLichHen,
                        principalTable: "LichHen",
                        principalColumn: "MaLichHen",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HoSoDichVu_NhanVien_MaNhanVien",
                        column: x => x.MaNhanVien,
                        principalTable: "NhanVien",
                        principalColumn: "MaNhanVien",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ThanhToan_LichHen_MaLichHen",
                        column: x => x.MaLichHen,
                        principalTable: "LichHen",
                        principalColumn: "MaLichHen",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DanhGia_MaLichHen",
                table: "DanhGia",
                column: "MaLichHen");

            migrationBuilder.CreateIndex(
                name: "IX_HoSoDichVu_MaLichHen",
                table: "HoSoDichVu",
                column: "MaLichHen");

            migrationBuilder.CreateIndex(
                name: "IX_HoSoDichVu_MaNhanVien",
                table: "HoSoDichVu",
                column: "MaNhanVien");

            migrationBuilder.CreateIndex(
                name: "IX_Images_MaThuCung",
                table: "Images",
                column: "MaThuCung");
